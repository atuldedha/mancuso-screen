...
const Header = () => {
  ...
  return (
    <div className="flex items-center bg-[#0B0F19] pl-[187px] pt-[46px]">
      ...
      <span
        ...
        } text-[#F2F0FF] text-[18px] font-inter text-center leading-[24px] hover:cursor-pointer`}
      ...
      <span
        ...
        } text-[#F2F0FF] text-[18px] font-inter text-center leading-[24px] hover:cursor-pointer mx-[41px]`}
